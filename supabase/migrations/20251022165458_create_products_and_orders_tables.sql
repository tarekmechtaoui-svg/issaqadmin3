/*
  ...
  - `subtotal` (numeric) - Order subtotal in dollars
  - `shipping` (numeric) - Shipping cost in dollars
  - `tax` (numeric) - Tax amount in dollars
  - `total` (numeric) - Total order amount in dollars
  ...
  - Add policy for public read access and authenticated admin access
  ...
  - Add policy allowing anyone to insert orders
  - Add policy for authenticated admin read/delete access

  ## Sample Data
  
  Inserts sample categories and products with realistic data for the store.
*/
